...
if (isset($_POST['submit'])) {
    $produit = "Canva Pro"; // Nom du produit
    ...
    $prix_unitaire = 10; // Prix unitaire pour Canva Pro
...
<head>
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            const prixUnitaire = 10; // Prix unitaire pour Canva Pro
...
<body>
    <div class="order-form">
        ...
        <form action="canva.php" method="POST" onsubmit="return validateForm()">
            ...
            <p id="prix-total">Total Price: 10 DT</p>
