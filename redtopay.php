...
if (isset($_POST['submit'])) {
    $produit = "RedToPay"; // Nom du produit
    ...
    $prix_unitaire = 4; // Prix unitaire pour RedToPay
...
<head>
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            const prixUnitaire = 4; // Prix unitaire pour RedToPay
...
<body>
    <div class="order-form">
        ...
        <form action="canva.php" method="POST" onsubmit="return validateForm()">
            ...
            <p id="prix-total">Total Price: 4 DT</p>
